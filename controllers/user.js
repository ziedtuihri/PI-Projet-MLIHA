...
const createUser = async (req, res) => {
  ...
  if (!nom || !prenom || !email || !motPasse || !role) {
  ...
  try {
      ...
      const newUser = new User({ nom, prenom, entreprise, matriculeFiscal, email, motPasse: hashedPassword, address, mobile, role });
